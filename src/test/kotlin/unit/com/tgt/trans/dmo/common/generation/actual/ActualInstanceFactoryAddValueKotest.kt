...
import com.tgt.trans.dmo.common.generation.MyThingWithNullableFields
import com.tgt.trans.dmo.common.generation.ThingWithListAndSet
...
class ActualInstanceFactoryAddValueKotest: StringSpec() {
    ...
    init {
        ...
        "handle instance with null fields" {
            ...
            buffer.qualifiedNames() shouldContainExactlyInAnyOrder  listOf(
                "com.tgt.trans.dmo.common.generation.MyThingWithNullableFields",
                "kotlin.String"
            )
        }
...
//            }
            ...
            buffer.qualifiedNames() shouldContainExactlyInAnyOrder listOf(
                ...
                "java.math.BigDecimal",
                "java.time.LocalDate",
                "com.tgt.trans.dmo.common.generation.ThingWithListAndSet",
            )
        }
...
//            }
            ...
            buffer.qualifiedNames() shouldContainExactlyInAnyOrder listOf(
                ...
                "com.tgt.trans.dmo.common.generation.MyThing",
                "java.math.BigDecimal",
                "com.tgt.trans.dmo.common.generation.MyThingWithPrivateWeight",
                "com.tgt.trans.dmo.common.generation.Fruit",
                "java.time.LocalDateTime",
                "com.tgt.trans.dmo.common.generation.FruitType",
                "com.tgt.trans.dmo.common.generation.NestedThing",
                "java.math.BigInteger",
                "com.tgt.trans.dmo.common.generation.ComplexThing",
            )
        }
    }
}