...
import com.tgt.trans.dmo.common.generation.WithAllBasicTypes
import com.tgt.trans.dmo.common.generation.WithAllTemporaryTypes
...
class SampleInstanceKotest: StringSpec() {
    ...
    init {
        "sampleInstance works for WithAllBasicTypes" {
            val actual = sut.sampleInstance(WithAllBasicTypes::class)
        ...
        "sampleInstance works for WithAllDates" {
            val actual = sut.sampleInstance(WithAllTemporaryTypes::class)
            actual.sourceCode() shouldBe listOf(
        ...
        "works with enums" {
            val actual = sut.sampleInstance(Fruit::class)
